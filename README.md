...
<p align="center">
  <a href="https://labex.io/courses/offline-password-cracking">
    <img src="https://course-cover.labex.io/offline-password-cracking.png" alt="Offline Password Cracking">
  </a>
</p>
...
[Start Course on LabEx](https://labex.io/courses/offline-password-cracking)

## Exercises

|   Index | Name                             | Difficulty   | Practice                                                                                                                                        |
|---------|----------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
|       1 | Custom Wordlist Generation       | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-custom-wordlist-generation-656192?course=offline-password-cracking'>Start Lab</a>          |
|       2 | Cracking with John the Ripper    | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-cracking-with-john-the-ripper-656191?course=offline-password-cracking'>Start Lab</a>       |
|       3 | High-Speed Cracking with Hashcat | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-high-speed-cracking-with-hashcat-656194?course=offline-password-cracking'>Start Lab</a>    |
|       4 | Hashcat Rule-Based Attacks       | Beginner     | <a target='_blank' href='https://labex.io/labs/linux-hashcat-rule-based-attacks-656193?course=offline-password-cracking'>Start Lab</a>          |
|       5 | Credential Recovery Operation    | Intermediate | <a target='_blank' href='https://labex.io/labs/linux-credential-recovery-operation-656190?course=offline-password-cracking'>Start Challenge</a> |
